import {Codec, struct, address, u64, u8, ref, sum, u16, fixedArray, string, tuple, unit} from '@subsquid/borsh'
...
export type PlatformConfigParam_FeeWallet = [
    string,
]

export const PlatformConfigParam_FeeWallet = tuple([
    address,
])

export type PlatformConfigParam_NFTWallet = [
    string,
]

export const PlatformConfigParam_NFTWallet = tuple([
    address,
])

export type PlatformConfigParam_MigrateNftInfo = [
    MigrateNftInfo,
]

export const PlatformConfigParam_MigrateNftInfo = tuple([
    ref(() => MigrateNftInfo),
])

export type PlatformConfigParam_FeeRate = [
    bigint,
]

export const PlatformConfigParam_FeeRate = tuple([
    u64,
])

export type PlatformConfigParam_Name = [
    string,
]

export const PlatformConfigParam_Name = tuple([
    string,
])

export type PlatformConfigParam_Web = [
    string,
]

export const PlatformConfigParam_Web = tuple([
    string,
])

export type PlatformConfigParam_Img = [
    string,
]

export const PlatformConfigParam_Img = tuple([
    string,
])
