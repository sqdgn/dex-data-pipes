...
export const LiquidityParameterByStrategyOneSide: Codec<LiquidityParameterByStrategyOneSide> =
  struct({
    /**
     * Amount of X token or Y token to deposit
     */
...
export const AddLiquiditySingleSidePreciseParameter: Codec<AddLiquiditySingleSidePreciseParameter> =
  struct({
