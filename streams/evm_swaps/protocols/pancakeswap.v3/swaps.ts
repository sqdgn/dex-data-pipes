...
export const events = {
  ...
  SetFeeProtocol: event(
    '0xb3159fed3ddfba67bae294599eafe2d0ec98c08bb38e0e5fb87d33154b6e05aa',
    'SetFeeProtocol(uint32,uint32,uint32,uint32)',
    {
      feeProtocol0Old: p.uint32,
      feeProtocol1Old: p.uint32,
      feeProtocol0New: p.uint32,
      feeProtocol1New: p.uint32,
    },
  ),
  SetLmPoolEvent: event(
    '0x29983690a85a11696ce8a357993744f8d5a74fde14653e517cc2f8608a7235e9',
    'SetLmPoolEvent(address)',
    { addr: p.address },
  ),
  Swap: event(
    ...
    'Swap(address,address,int256,int256,uint160,uint128,int24,uint128,uint128)',
    {
      ...
      liquidity: p.uint128,
      tick: p.int24,
      protocolFeesToken0: p.uint128,
      protocolFeesToken1: p.uint128,
    },
  ),
};
...
export const functions = {
  ...
  setFeeProtocol: fun('0xb0d0d211', 'setFeeProtocol(uint32,uint32)', {
