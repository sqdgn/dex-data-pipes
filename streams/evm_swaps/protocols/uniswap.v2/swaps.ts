...
export const events = {
  ...
  Burn: event(
    ...
    { sender: indexed(p.address), amount0: p.uint256, amount1: p.uint256, to: indexed(p.address) },
  ),
  Mint: event(
  ...
  Sync: event(
    ...
    { reserve0: p.uint112, reserve1: p.uint112 },
  ),
  Transfer: event(
...
export const functions = {
  ...
  getReserves: viewFun(
    ...
    'getReserves()',
    {},
    { _reserve0: p.uint112, _reserve1: p.uint112, _blockTimestampLast: p.uint32 },
  ),
