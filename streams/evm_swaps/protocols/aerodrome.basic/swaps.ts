// Aerodrome basic pool
// ex: https://basescan.org/address/0xcdac0d6c6c59727a65f871236188350531885c43
...
export const events = {
  ...
  Burn: event(
    ...
    { sender: indexed(p.address), to: indexed(p.address), amount0: p.uint256, amount1: p.uint256 },
  ),
  Claim: event(
  ...
  Fees: event(
    ...
    { sender: indexed(p.address), amount0: p.uint256, amount1: p.uint256 },
  ),
  Mint: event(
  ...
  Sync: event(
    ...
    { reserve0: p.uint256, reserve1: p.uint256 },
  ),
  Transfer: event(
...
export const functions = {
  ...
  approve: fun(
    ...
    { spender: p.address, amount: p.uint256 },
    p.bool,
  ),
  ...
  currentCumulativePrices: viewFun(
    '0x1df8c717',
    'currentCumulativePrices()',
    {},
    { reserve0Cumulative: p.uint256, reserve1Cumulative: p.uint256, blockTimestamp: p.uint256 },
  ),
  ...
  getAmountOut: viewFun(
    '0xf140a35a',
    'getAmountOut(uint256,address)',
    { amountIn: p.uint256, tokenIn: p.address },
    p.uint256,
  ),
  ...
  getReserves: viewFun(
    ...
    'getReserves()',
    {},
    { _reserve0: p.uint256, _reserve1: p.uint256, _blockTimestampLast: p.uint256 },
  ),
  ...
  initialize: fun('0xe4bbb5a8', 'initialize(address,address,bool)', {
    _token0: p.address,
    _token1: p.address,
    _stable: p.bool,
  }),
  lastObservation: viewFun(
    '0x8a7b8cf2',
    'lastObservation()',
    {},
    p.struct({
  ...
  observations: viewFun(
    ...
    { _0: p.uint256 },
    { timestamp: p.uint256, reserve0Cumulative: p.uint256, reserve1Cumulative: p.uint256 },
  ),
  ...
  prices: viewFun(
    ...
    { tokenIn: p.address, amountIn: p.uint256, points: p.uint256 },
    p.array(p.uint256),
  ),
  quote: viewFun(
    '0x9e8cc04b',
    'quote(address,uint256,uint256)',
    { tokenIn: p.address, amountIn: p.uint256, granularity: p.uint256 },
    p.uint256,
  ),
  ...
  sample: viewFun(
    ...
    { tokenIn: p.address, amountIn: p.uint256, points: p.uint256, window: p.uint256 },
    p.array(p.uint256),
  ),
  ...
  swap: fun('0x022c0d9f', 'swap(uint256,uint256,address,bytes)', {
    amount0Out: p.uint256,
    amount1Out: p.uint256,
    to: p.address,
    data: p.bytes,
  ...
  transfer: fun(
    ...
    { to: p.address, amount: p.uint256 },
    p.bool,
  ),
  transferFrom: fun(
    '0x23b872dd',
    'transferFrom(address,address,uint256)',
    { from: p.address, to: p.address, amount: p.uint256 },
    p.bool,
  ),
};
...
export class Contract extends ContractBase {
  ...
  prices(
    tokenIn: PricesParams['tokenIn'],
    amountIn: PricesParams['amountIn'],
    points: PricesParams['points'],
  ) {
  ...
  quote(
    ...
    granularity: QuoteParams['granularity'],
  ) {
  ...
  sample(
    tokenIn: SampleParams['tokenIn'],
    amountIn: SampleParams['amountIn'],
    points: SampleParams['points'],
    window: SampleParams['window'],
  ) {
...
export type CurrentCumulativePricesParams = FunctionArguments<
  typeof functions.currentCumulativePrices
>;
export type CurrentCumulativePricesReturn = FunctionReturn<
  typeof functions.currentCumulativePrices
>;
...
export type Reserve0CumulativeLastParams = FunctionArguments<
  typeof functions.reserve0CumulativeLast
>;
...
export type Reserve1CumulativeLastParams = FunctionArguments<
  typeof functions.reserve1CumulativeLast
>;
